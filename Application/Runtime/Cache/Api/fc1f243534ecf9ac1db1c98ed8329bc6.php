	...
	<div class="tab-form">
		...
		<form action="/api/user/doReg1" method="post" >
			...
			<div class="check check-a check-about" >
				<input type="submit" id="but" value="同意协议并注册" >
			</div>
		</form>
		</div>
		...
		<form action="/api/user/doReg2" method="post">
			...
			<div class="tab-line">
				<span>图像验证码:</span>
				<input type="text" placeholder="请输入验证码" name="verifyCode1" class="line-pmg1" title="请填写此字段" >
				<span class="make-number">
				    <img src="/api/user/verifyCode" class="verify"></img>
				</span>
				<p class="hide"></p>
			...
			<div class="tab-line">
				<span>设置密码:</span>
				<input type="password" placeholder="请输入密码" name="password" title="请填写此字段" class="click-mi">
				<p class="hide"></p>

			</div>
			<div class="tab-line">
				<span>确认密码:</span>
				<input type="password" placeholder="请再次输入密码" name="password" title="请填写此字段" class="click-que">
				<p class="hide"></p>
			...
			<div class="check check-a check-click" >
				<input type="submit" name="b1" value="同意协议并注册" id="b1">
			</div>
		</form>
		</div>
	</div>
