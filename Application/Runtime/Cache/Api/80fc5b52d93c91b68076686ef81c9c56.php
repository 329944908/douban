...
<body>
	...
	<div class="detail-box clearfix">
		<div class="detail-header">
			<a href="<?php echo U('/goods/lists',array('id'=>$classifyArr['parent_parent_classify']['id']));?>"><?php echo $classifyArr['parent_parent_classify']['name'];?></a>
		    <i class="path-ico"></i>
            <a href="<?php echo U('/goods/lists',array('id'=>$classifyArr['parent_classify']['id']));?>"><?php echo $classifyArr['parent_classify']['name'];?></a>
		    <i class="path-ico"></i>
		    <a href="<?php echo U('/goods/lists',array('id'=>$classifyArr['classify']['id']));?>"><?php echo $classifyArr['classify']['name'];?></a>
		    <i class="path-ico"></i>
		    <a href="javascript:void(0)">
