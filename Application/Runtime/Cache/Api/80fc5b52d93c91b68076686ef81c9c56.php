...
<body>
	...
	<div class="detail-box clearfix">
		<div class="detail-header">
			<a href="<?php echo U('/api/goods/lists',array('id'=>$classifyArr['parent_parent_classify']['id']));?>"><?php echo $classifyArr['parent_parent_classify']['name'];?></a>
		    <i class="path-ico"></i>
            <a href="<?php echo U('/api/goods/lists',array('id'=>$classifyArr['parent_classify']['id']));?>"><?php echo $classifyArr['parent_classify']['name'];?></a>
		    <i class="path-ico"></i>
		    <a href="<?php echo U('/api/goods/lists',array('id'=>$classifyArr['classify']['id']));?>"><?php echo $classifyArr['classify']['name'];?></a>
		    <i class="path-ico"></i>
		    <a href="javascript:void(0)">
		...
		<div class="introduction clearfix">
			<div class="introdu-img clearfix">
				...
				<div class="hover-lun clearfix">
					<?php foreach ($goods['imgs'] as $key => $value) { ?>
			...
			<div class="data-right">
				...
				<div class="tab-numbid">
					<div class="numdiv-one">
						<?php echo html_entity_decode($goods['details']);?>
					</div>
					<div class="numdiv-one  hide">
						<div class="pin">
							...
							<p><span>皮牌</span><span>长虹555555</span></p>
									...
									<div class="numdiv-one hide clearfix" id="num-focus">
					    <div class="num-title">
					       <h2>商品评论</h2>
					    </div>
						<ul class="clearfix num-mul">
							<li><span>67%</span></li>
							<li class="num-good">
								<div class="num-good write-box">
									<span>好评</span><span>(67%)</span><span><i></i></span>
								</div>
								<div class="num-min write-box">
									<span>中评</span><span>(34%)</span><span><i></i></span>
								</div>
								<div class="num-bad write-box">
									<span>差评</span><span>(0%)</span><span><i></i></span>
								</div>
							</li>
							<li class="suggle">
							    <span>买家评论事项：购买后有什么问题, 满意, 或者不不满, 都可以在这里评论出来, 这里评论全部源于真实的评论.</span>
							</li>
							<li><span>您可以对已购的商品进行评价</span>
                                <a href="javascript:void(0)">发表评论</a>
							</li>
						</ul>
						<div class="new-lion">
							<ul class="clearfix">
								<li class="lion-line"><a href="javascript:void(0)" class="line-red">全部评论（2）</a></li>
								<li><a href="javascript:void(0)">好评（1） </a></li>
								<li><a href="javascript:void(0)">中评（1） </a></li>
								<li><a href="javascript:void(0)">差评 </a></li>
								<li><a href="javascript:void(0)">有图 </a></li>
							</ul>
							<div class="lion-cont">
								<div>
									<div class="info-cont clearfix">
										<div class="info-img">
											<img src="/Public/api/image/headPic.jpg" alt=""><span>匿名用户</span>
										</div>
										<div class="info-talk">
											<div class="start">
												<i></i>
											...
											<div><p>晒单给大家看看.我刚买的.</p></div>
											<div class="shai-img">
												<a href="javascript:void(0)"><img src="/Public/api/image/goods1.jpg" alt=""></a>
												<a href="javascript:void(0)"><img src="/Public/api/image/goods2.jpg" alt=""></a>
												<a href="javascript:void(0)"><img src="/Public/api/image/goods3.jpg" alt=""></a>
											</div>
											<div class="info-time">
												<span>2016-03-12 09:37:06</span>
												<a href="javascript:void(0)"><i></i>0</a>
											</div>
										</div>
									</div>
									<div class="info-cont clearfix">
								...
								<div class="hide">
									<div class="info-cont clearfix">
										...
										<div class="info-talk">
											...
											<div><p>晒单给大家看看.我刚买的.</p></div>
											<div class="shai-img">
												<a href="javascript:void(0)"><img src="/Public/api/image/goods4.jpg" alt=""></a>
												<a href="javascript:void(0)"><img src="/Public/api/image/goods1.jpg" alt=""></a>
												<a href="javascript:void(0)"><img src="/Public/api/image/goods3.jpg" alt=""></a>
											</div>
											<div class="info-time">
								...
								<div class="hide">
									<div class="info-cont clearfix">
										...
										<div class="info-talk">
											...
											<div><p>晒单给大家看看.我刚买的.</p></div>
											<div class="shai-img">
												<a href="javascript:void(0)"><img src="/Public/api/image/some1.jpg" alt=""></a>
												<a href="javascript:void(0)"><img src="/Public/api/image/some2.jpg" alt=""></a>
												<a href="javascript:void(0)"><img src="/Public/api/image/some3.jpg" alt=""></a>
											</div>
											<div class="info-time">
												<span>2016-03-12 09:37:06</span>
												<a href="javascript:void(0)"><i></i>0</a>
