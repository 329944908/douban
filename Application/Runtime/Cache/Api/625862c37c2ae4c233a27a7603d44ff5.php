...
<body>
		...
		<div class="nav-search clearfix">
			...
			<div class="search-middle">
				<span class="search-text clearfix">
						...
						<input type="text" placeholder="请输入搜素关键词..." name="q">
	...
	<div class="seach-path">
		...
		<i class="path-ico"></i>
		<a href="javascript:void(0)"><?php  if($parent_parent_classify['name']){ echo $parent_parent_classify['name']; }else{ echo $parent_classify['name']; }?></a>
		<i class="path-ico"></i>
		<div class="path-box">
				...
				<div class="shop-buy">
					<div class="buy-info">
					    ...
					    <?php foreach ($value['imgs'] as $k => $v) { if($k == 0){ ?>
					    	...
					    	<?php } ?>
							<img src="<?php echo $value['imgs'][$k+1]['img'];?>" alt="" class="img  hide">
						<?php } ?>
					    </a>
						<ul class="clearfix">
