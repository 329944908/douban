...
<head>
    ...
    <link rel="shortcut icon" href="/Public/admin/assets/favicon.ico"> <link href="/Public/admin/assets/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="/Public/admin/assets/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="/Public/admin/assets/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    ...
    <link href="/Public/admin/assets/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <ul class="todo-list m-t small-list ui-sortable">
                                <li>
                                    <a href="/Public/admin/assets/widgets.html#" class="check-link"><i class="fa fa-check-square"></i> </a>
                                ...
                                <li>
                                    <a href="/Public/admin/assets/widgets.html#" class="check-link"><i class="fa fa-square-o"></i> </a>
...
<script src="/Public/admin/assets/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="/Public/admin/assets/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="/Public/admin/assets/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="/Public/admin/assets/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="/Public/admin/assets/js/plugins/flot/jquery.flot.symbol.js"></script>
<script src="/Public/admin/assets/js/plugins/peity/jquery.peity.min.js"></script>
<script src="/Public/admin/assets/js/demo/peity-demo.min.js"></script>
<script src="/Public/admin/assets/js/content.min.js?v=1.0.0"></script>
<script src="/Public/admin/assets/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="/Public/admin/assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/Public/admin/assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="/Public/admin/assets/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="/Public/admin/assets/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="/Public/admin/assets/js/demo/sparkline-demo.min.js"></script>
<script>
...
<script type="text/javascript" src="/Public/admin/assets/http://tajs.qq.com/stats?sId=9051096" charset="UTF-8"></script>
</body>
