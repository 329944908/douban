                        ...
                        <div class="ibox">
                            <div class="ibox-content">
                                <form role="form" class="form-inline" action="<?php echo U('admin/goods/lists');?>" method="get" target="_self">
                                    ...
                                    <a href="<?php echo U('admin/Spec/edit');?>" class="btn btn-primary" type="submit" target="_self">新增</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td><?php echo ($goodsType1[$vo['type_id']]); ?></td>
                                <td><?php echo ($vo["item"]); ?></td>
                                <td><a href="<?php echo U('admin/Spec/addItem',array('id'=>$vo['id']));?>">添加规格项</a></td>
