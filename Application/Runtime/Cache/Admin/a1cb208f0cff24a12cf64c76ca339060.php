            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" action="<?php echo U('save');?>" method="post" target="_self" enctype="multipart/form-data">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label">所属商品模型：</label>
                                <div class="col-sm-5">
                                    <select class="form-control m-b" name="type_id">
                                    <?php foreach ($goodsType as $value) { ?>
                                        <option value="<?php echo $value['id'];?>" <?php if($data['type_id']==$value['id']) {?> selected="selected"<?php } ?>><?php echo $value['name'];?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                            </div>
                           <!--  <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                        <textarea name="item" cols="30" rows="5">
                                        </textarea>
                                </div>
                            </div> -->
